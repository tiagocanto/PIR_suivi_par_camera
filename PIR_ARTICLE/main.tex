...
After testing the model from the project \cite{b8} in some images from the captured match, positive results were achieved, but it had some problems confusing the arbitrator with a player, not identifying all the players, and sometimes not seeing the ball.  
